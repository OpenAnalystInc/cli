...
#[command(name = "openanalyst-cli", version, about = "OpenAnalyst CLI")]
pub struct Cli {
    #[arg(long, default_value = "openanalyst-beta")]
    pub model: String,
