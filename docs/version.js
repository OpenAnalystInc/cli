/**
 * Auto-version: fetches the latest release tag from GitHub and updates
 * all elements with class "oa-version" or data-version-prefix attributes.
 *
 * Usage in HTML:
 *   <span class="oa-version">2.0.30</span>          -> replaced with latest tag (no "v")
 *   <span class="oa-version-full">v2.0.30</span>    -> replaced with "v2.0.30"
 *   <span data-version-prefix="Documentation v">Documentation v2.0.30</span>
 *
...
(function () {
  ...
  fetch('https://api.github.com/repos/' + REPO + '/releases/latest', {
    ...
    .catch(function () {
      // Offline or rate-limited: keep the hardcoded fallback text.
    });
})();
