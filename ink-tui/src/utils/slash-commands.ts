...
const COMMANDS: readonly SlashCommand[] = [
  ...
  { name: 'permissions', aliases: ['perm'],      description: 'Show or cycle permission mode',         handler: 'local' },
  ...
  { name: 'feedback',    aliases: ['fb', 'rate'],description: 'Submit feedback or correction',         handler: 'engine' },
  ...
  { name: 'tokens',      aliases: ['count-tokens'], description: 'Show token count for context',      handler: 'engine' },
  ...
  { name: 'hooks',       aliases: ['hook'],      description: 'Manage event hooks',                   handler: 'engine' },
  ...
  { name: 'diff-review', aliases: ['dr', 'review'], description: 'AI-powered diff review',            handler: 'engine' },
  ...
  { name: 'changelog',   aliases: ['release-notes'], description: 'Generate changelog from commits',  handler: 'engine' },

  // ── AI & planning ──
  { name: 'think',       aliases: [],            description: 'Extended thinking mode',               handler: 'engine' },
  { name: 'effort',      aliases: ['budget'],    description: 'Set effort budget for next prompt',    handler: 'engine' },
  { name: 'route',       aliases: ['routing', 'router'], description: 'Set model routing for action type', handler: 'engine' },
  { name: 'ultraplan',   aliases: [],            description: 'Deep multi-step planning mode',        handler: 'engine' },
  { name: 'bughunter',   aliases: ['bh'],        description: 'Find and fix bugs in codebase',       handler: 'engine' },
  { name: 'explore',     aliases: ['repo-explore'], description: 'Explore codebase structure',        handler: 'engine' },
  ...
  { name: 'add-dir',     aliases: ['add-directory'], description: 'Add directory to context',         handler: 'engine' },
  { name: 'undo',        aliases: ['revert'],    description: 'Undo last action',                     handler: 'engine' },

  // ── Output & generation ──
  { name: 'image',       aliases: ['img'],       description: 'Generate image from prompt',           handler: 'engine' },
  { name: 'voice',       aliases: ['transcribe', 'whisper'], description: 'Voice input settings',     handler: 'engine' },
  { name: 'speak',       aliases: ['tts'],       description: 'Text-to-speech output',                handler: 'engine' },
  { name: 'diagram',     aliases: ['diag', 'mermaid'], description: 'Generate diagram from description', handler: 'engine' },
  { name: 'translate',   aliases: ['tr'],        description: 'Translate text between languages',     handler: 'engine' },
  { name: 'json',        aliases: ['api'],       description: 'Output structured JSON response',      handler: 'engine' },
  { name: 'output-style',aliases: ['style'],     description: 'Set output formatting style',          handler: 'engine' },

  // ── Browser & Playwright ──
  { name: 'dev',         aliases: ['browser', 'playwright'], description: 'Open browser with Playwright', handler: 'engine' },
  { name: 'scrape',      aliases: [],            description: 'Scrape web page content',              handler: 'engine' },
  { name: 'vision',      aliases: ['describe-image'], description: 'Analyze image or screenshot',     handler: 'engine' },

  // ── Knowledge base ──
  { name: 'knowledge',   aliases: ['kb'],        description: 'Query knowledge base directly',        handler: 'engine' },

  // ── Misc ──
  { name: 'ask',         aliases: ['btw'],       description: 'Ask a question to specific agent',     handler: 'engine' },
  { name: 'user-prompt', aliases: ['up'],        description: 'Set custom system prompt',             handler: 'engine' },
