...
Write-Host ""
Write-Host ""
Write-Host "     OOOOO    AAA" -ForegroundColor Blue
Write-Host "    OO   OO  AA AA" -ForegroundColor Cyan
Write-Host "    OO   OO  AAAAA" -ForegroundColor Cyan
Write-Host "    OO   OO  AA AA" -ForegroundColor Cyan
Write-Host "     OOOOO   AA AA" -ForegroundColor Blue
Write-Host ""
Write-Host "   OpenAnalyst CLI  " -ForegroundColor White -NoNewline
Write-Host "v1.0.1" -ForegroundColor DarkGray
...
Write-Host ""
Write-Host "   Switch models: /model gpt-4o" -ForegroundColor DarkGray
Write-Host "   Update:        openanalyst update" -ForegroundColor DarkGray
Write-Host "   Uninstall:     openanalyst uninstall" -ForegroundColor DarkGray
Write-Host ""
